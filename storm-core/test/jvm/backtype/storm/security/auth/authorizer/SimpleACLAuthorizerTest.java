...
public class SimpleACLAuthorizerTest {
    ...
    public void SimpleACLUserAuthTest(){
        ...
        Assert.assertTrue(authorizer.permit(new ReqContext(adminUser),"getSchedulerConf", new HashMap<>()));
        Assert.assertFalse(authorizer.permit(new ReqContext(supervisorUser),"getSchedulerConf", new HashMap<>()));
        Assert.assertTrue(authorizer.permit(new ReqContext(userA),"getSchedulerConf", new HashMap<>()));
        Assert.assertTrue(authorizer.permit(new ReqContext(userB),"getSchedulerConf", new HashMap<>()));
        ...
        Assert.assertTrue(authorizer.permit(new ReqContext(adminUser),"getOwnerResourceSummaries", new HashMap<>()));
        Assert.assertFalse(authorizer.permit(new ReqContext(supervisorUser),"getOwnerResourceSummaries", new HashMap<>()));
        Assert.assertTrue(authorizer.permit(new ReqContext(userA),"getOwnerResourceSummaries", new HashMap<>()));
        Assert.assertTrue(authorizer.permit(new ReqContext(userB),"getOwnerResourceSummaries", new HashMap<>()));
