...
public class TestFileConfigLoader {
    ...
    public void testValidFileBase() throws Exception {
        testValidFile(new FileConfigLoader(), FileConfigLoader.LOCAL_FILE_YAML);
    }

    public void testValidFile(FileConfigLoader loader, String setting) throws Exception {
        File temp = File.createTempFile("FileLoader", ".yaml");
        temp.deleteOnExit();
