...
public class BasicContainerTest {
    ...
    public void testRunProfiling() throws Exception {
        ...
        final String wa = ContainerTest.asAbsPath(stormLocal, "workers-artifacts");
        final String topoRoot = ContainerTest.asAbsPath(wa, topoId, String.valueOf(port));
