...
public interface ILocalCluster {
    ...
    ComponentPageInfo getComponentPageInfo(String id, String componentId, String window, boolean includeSystem) throws NotAliveException, AuthorizationException;
    Map getState();
}
