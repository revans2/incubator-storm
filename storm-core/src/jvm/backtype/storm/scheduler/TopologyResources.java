...
public class TopologyResources {
    ...
    protected TopologyResources(double requestedMemOnHeap, double requestedMemOffHeap, 
            ...
            double requestedCpu, 
            double assignedMemOnHeap, double assignedMemOffHeap,
            double assignedSharedMemOnHeap, double assignedSharedMemOffHeap,
            double assignedNonSharedMemOnHeap, double assignedNonSharedMemOffHeap,
            double assignedCpu) {
    ...
    public TopologyResources add(TopologyResources other) {
        return new TopologyResources(requestedMemOnHeap + other.requestedMemOnHeap,
