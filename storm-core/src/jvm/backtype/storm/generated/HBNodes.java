            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list544.size);
                String _elem545;
                for (int _i546 = 0; _i546 < _list544.size; ++_i546)
                {
                  _elem545 = iprot.readString();
                  struct.pulseIds.add(_elem545);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter547 : struct.pulseIds)
          {
            oprot.writeString(_iter547);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter548 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list549.size);
          String _elem550;
          for (int _i551 = 0; _i551 < _list549.size; ++_i551)
          {
            _elem550 = iprot.readString();
            struct.pulseIds.add(_elem550);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
