            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list684.size);
                String _elem685;
                for (int _i686 = 0; _i686 < _list684.size; ++_i686)
                {
                  _elem685 = iprot.readString();
                  struct.pulseIds.add(_elem685);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter687 : struct.pulseIds)
          {
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter688 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list689.size);
          String _elem690;
          for (int _i691 = 0; _i691 < _list689.size; ++_i691)
          {
            _elem690 = iprot.readString();
            struct.pulseIds.add(_elem690);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
