            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list614.size);
                String _elem615;
                for (int _i616 = 0; _i616 < _list614.size; ++_i616)
                {
                  _elem615 = iprot.readString();
                  struct.pulseIds.add(_elem615);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter617 : struct.pulseIds)
          {
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter618 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list619.size);
          String _elem620;
          for (int _i621 = 0; _i621 < _list619.size; ++_i621)
          {
            _elem620 = iprot.readString();
            struct.pulseIds.add(_elem620);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
