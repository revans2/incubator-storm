            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list664.size);
                String _elem665;
                for (int _i666 = 0; _i666 < _list664.size; ++_i666)
                {
                  _elem665 = iprot.readString();
                  struct.pulseIds.add(_elem665);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter667 : struct.pulseIds)
          {
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter668 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list669.size);
          String _elem670;
          for (int _i671 = 0; _i671 < _list669.size; ++_i671)
          {
            _elem670 = iprot.readString();
            struct.pulseIds.add(_elem670);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
