            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list426.size);
                String _elem427;
                for (int _i428 = 0; _i428 < _list426.size; ++_i428)
                {
                  _elem427 = iprot.readString();
                  struct.pulseIds.add(_elem427);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter429 : struct.pulseIds)
          {
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter430 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list431.size);
          String _elem432;
          for (int _i433 = 0; _i433 < _list431.size; ++_i433)
          {
            _elem432 = iprot.readString();
            struct.pulseIds.add(_elem432);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
