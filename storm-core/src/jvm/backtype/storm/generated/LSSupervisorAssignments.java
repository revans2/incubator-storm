            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map564.size);
                int _key565;
                LocalAssignment _val566;
                for (int _i567 = 0; _i567 < _map564.size; ++_i567)
                {
                  _key565 = iprot.readI32();
                  _val566 = new LocalAssignment();
                  _val566.read(iprot);
                  struct.assignments.put(_key565, _val566);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter568 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter568.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter569 : struct.assignments.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map570.size);
        int _key571;
        LocalAssignment _val572;
        for (int _i573 = 0; _i573 < _map570.size; ++_i573)
        {
          _key571 = iprot.readI32();
          _val572 = new LocalAssignment();
          _val572.read(iprot);
          struct.assignments.put(_key571, _val572);
        }
      }
      struct.set_assignments_isSet(true);
    }
