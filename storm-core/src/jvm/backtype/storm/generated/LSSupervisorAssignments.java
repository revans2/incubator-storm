            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map584.size);
                int _key585;
                LocalAssignment _val586;
                for (int _i587 = 0; _i587 < _map584.size; ++_i587)
                {
                  _key585 = iprot.readI32();
                  _val586 = new LocalAssignment();
                  _val586.read(iprot);
                  struct.assignments.put(_key585, _val586);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter588 : struct.assignments.entrySet())
          {
            oprot.writeI32(_iter588.getKey());
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter589 : struct.assignments.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map590 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map590.size);
        int _key591;
        LocalAssignment _val592;
        for (int _i593 = 0; _i593 < _map590.size; ++_i593)
        {
          _key591 = iprot.readI32();
          _val592 = new LocalAssignment();
          _val592.read(iprot);
          struct.assignments.put(_key591, _val592);
        }
      }
      struct.set_assignments_isSet(true);
    }
