            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.emitted = new HashMap<String,Long>(2*_map326.size);
                String _key327;
                long _val328;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.transferred = new HashMap<String,Long>(2*_map330.size);
                String _key331;
                long _val332;
                for (int _i333 = 0; _i333 < _map330.size; ++_i333)
                {
                  ...
                  struct.transferred.put(_key331, _val332);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.complete_latencies = new HashMap<String,Double>(2*_map334.size);
                String _key335;
                double _val336;
                for (int _i337 = 0; _i337 < _map334.size; ++_i337)
                {
                  ...
                  struct.complete_latencies.put(_key335, _val336);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.acked = new HashMap<String,Long>(2*_map338.size);
                String _key339;
                long _val340;
                for (int _i341 = 0; _i341 < _map338.size; ++_i341)
                {
                  ...
                  struct.acked.put(_key339, _val340);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.failed = new HashMap<String,Long>(2*_map342.size);
                String _key343;
                long _val344;
      ...
      if (struct.emitted != null) {
        if (struct.is_set_emitted()) {
          oprot.writeFieldBegin(EMITTED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter346 : struct.emitted.entrySet())
            {
      ...
      if (struct.transferred != null) {
        if (struct.is_set_transferred()) {
          oprot.writeFieldBegin(TRANSFERRED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter347 : struct.transferred.entrySet())
            {
      ...
      if (struct.complete_latencies != null) {
        if (struct.is_set_complete_latencies()) {
          oprot.writeFieldBegin(COMPLETE_LATENCIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter348 : struct.complete_latencies.entrySet())
            {
      ...
      if (struct.acked != null) {
        if (struct.is_set_acked()) {
          oprot.writeFieldBegin(ACKED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter349 : struct.acked.entrySet())
            {
      ...
      if (struct.failed != null) {
        if (struct.is_set_failed()) {
          oprot.writeFieldBegin(FAILED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter350 : struct.failed.entrySet())
            {
      ...
      if (struct.is_set_emitted()) {
        {
          ...
          for (Map.Entry<String, Long> _iter351 : struct.emitted.entrySet())
          {
      ...
      if (struct.is_set_transferred()) {
        {
          ...
          for (Map.Entry<String, Long> _iter352 : struct.transferred.entrySet())
          {
      ...
      if (struct.is_set_complete_latencies()) {
        {
          ...
          for (Map.Entry<String, Double> _iter353 : struct.complete_latencies.entrySet())
          {
      ...
      if (struct.is_set_acked()) {
        {
          ...
          for (Map.Entry<String, Long> _iter354 : struct.acked.entrySet())
          {
      ...
      if (struct.is_set_failed()) {
        {
          ...
          for (Map.Entry<String, Long> _iter355 : struct.failed.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.emitted = new HashMap<String,Long>(2*_map356.size);
          String _key357;
          long _val358;
          for (int _i359 = 0; _i359 < _map356.size; ++_i359)
          {
            ...
            struct.emitted.put(_key357, _val358);
          }
        }
        struct.set_emitted_isSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.transferred = new HashMap<String,Long>(2*_map360.size);
          String _key361;
          long _val362;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.complete_latencies = new HashMap<String,Double>(2*_map364.size);
          String _key365;
          double _val366;
          for (int _i367 = 0; _i367 < _map364.size; ++_i367)
          {
            ...
            struct.complete_latencies.put(_key365, _val366);
          }
        }
        struct.set_complete_latencies_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.acked = new HashMap<String,Long>(2*_map368.size);
          String _key369;
          long _val370;
          for (int _i371 = 0; _i371 < _map368.size; ++_i371)
          {
            ...
            struct.acked.put(_key369, _val370);
          }
        }
        struct.set_acked_isSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.failed = new HashMap<String,Long>(2*_map372.size);
          String _key373;
          long _val374;
          for (int _i375 = 0; _i375 < _map372.size; ++_i375)
          {
            ...
            struct.failed.put(_key373, _val374);
          }
        }
        struct.set_failed_isSet(true);
      }
