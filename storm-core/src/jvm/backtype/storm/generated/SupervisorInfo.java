...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.used_ports = new ArrayList<Long>(_list436.size);
                long _elem437;
                for (int _i438 = 0; _i438 < _list436.size; ++_i438)
                {
                  _elem437 = iprot.readI64();
                  struct.used_ports.add(_elem437);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.meta = new ArrayList<Long>(_list439.size);
                long _elem440;
                for (int _i441 = 0; _i441 < _list439.size; ++_i441)
                {
                  _elem440 = iprot.readI64();
                  struct.meta.add(_elem440);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.scheduler_meta = new HashMap<String,String>(2*_map442.size);
                String _key443;
                String _val444;
                for (int _i445 = 0; _i445 < _map442.size; ++_i445)
                {
                  ...
                  struct.scheduler_meta.put(_key443, _val444);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter446 : struct.used_ports)
            {
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter448 : struct.scheduler_meta.entrySet())
            {
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter449 : struct.used_ports)
          {
      ...
      if (struct.is_set_meta()) {
        {
          ...
          for (long _iter450 : struct.meta)
          {
            oprot.writeI64(_iter450);
          }
        }
      }
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter451 : struct.scheduler_meta.entrySet())
          {
            oprot.writeString(_iter451.getKey());
            oprot.writeString(_iter451.getValue());
          }
        }
      }
      if (struct.is_set_uptime_secs()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list452 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list455 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
