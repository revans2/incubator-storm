...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.used_ports = new ArrayList<Long>(_list446.size);
                long _elem447;
                for (int _i448 = 0; _i448 < _list446.size; ++_i448)
                {
                  _elem447 = iprot.readI64();
                  struct.used_ports.add(_elem447);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.meta = new ArrayList<Long>(_list449.size);
                long _elem450;
                for (int _i451 = 0; _i451 < _list449.size; ++_i451)
                {
                  _elem450 = iprot.readI64();
                  struct.meta.add(_elem450);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.scheduler_meta = new HashMap<String,String>(2*_map452.size);
                String _key453;
                String _val454;
                for (int _i455 = 0; _i455 < _map452.size; ++_i455)
                {
                  ...
                  struct.scheduler_meta.put(_key453, _val454);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.resources_map = new HashMap<String,Double>(2*_map456.size);
                String _key457;
                double _val458;
                for (int _i459 = 0; _i459 < _map456.size; ++_i459)
                {
                  _key457 = iprot.readString();
                  _val458 = iprot.readDouble();
                  struct.resources_map.put(_key457, _val458);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter460 : struct.used_ports)
            {
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter462 : struct.scheduler_meta.entrySet())
            {
      ...
      if (struct.resources_map != null) {
        if (struct.is_set_resources_map()) {
          oprot.writeFieldBegin(RESOURCES_MAP_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter463 : struct.resources_map.entrySet())
            {
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter464 : struct.used_ports)
          {
      ...
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter466 : struct.scheduler_meta.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map478 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.resources_map = new HashMap<String,Double>(2*_map478.size);
          String _key479;
          double _val480;
          for (int _i481 = 0; _i481 < _map478.size; ++_i481)
          {
            _key479 = iprot.readString();
            _val480 = iprot.readDouble();
            struct.resources_map.put(_key479, _val480);
          }
        }
        struct.set_resources_map_isSet(true);
      }
