      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter496 : struct.used_ports)
            {
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter498 : struct.scheduler_meta.entrySet())
            {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter499 : struct.used_ports)
          {
      ...
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter501 : struct.scheduler_meta.entrySet())
          {
            oprot.writeString(_iter501.getKey());
            oprot.writeString(_iter501.getValue());
          }
        }
      }
      if (struct.is_set_uptime_secs()) {
