            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<Pulse>(_list606.size);
                Pulse _elem607;
                for (int _i608 = 0; _i608 < _list606.size; ++_i608)
                {
                  _elem607 = new Pulse();
                  _elem607.read(iprot);
                  struct.pulses.add(_elem607);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (Pulse _iter609 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (Pulse _iter610 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<Pulse>(_list611.size);
          Pulse _elem612;
          for (int _i613 = 0; _i613 < _list611.size; ++_i613)
          {
            _elem612 = new Pulse();
            _elem612.read(iprot);
            struct.pulses.add(_elem612);
          }
        }
        struct.set_pulses_isSet(true);
      }
