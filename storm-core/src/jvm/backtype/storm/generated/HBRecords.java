            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list656.size);
                HBPulse _elem657;
                for (int _i658 = 0; _i658 < _list656.size; ++_i658)
                {
                  _elem657 = new HBPulse();
                  _elem657.read(iprot);
                  struct.pulses.add(_elem657);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (HBPulse _iter659 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (HBPulse _iter660 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list661.size);
          HBPulse _elem662;
          for (int _i663 = 0; _i663 < _list661.size; ++_i663)
          {
            _elem662 = new HBPulse();
            _elem662.read(iprot);
            struct.pulses.add(_elem662);
          }
        }
        struct.set_pulses_isSet(true);
      }
