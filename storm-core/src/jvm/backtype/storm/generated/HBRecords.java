            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list676.size);
                HBPulse _elem677;
                for (int _i678 = 0; _i678 < _list676.size; ++_i678)
                {
                  _elem677 = new HBPulse();
                  _elem677.read(iprot);
                  struct.pulses.add(_elem677);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (HBPulse _iter679 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (HBPulse _iter680 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list681.size);
          HBPulse _elem682;
          for (int _i683 = 0; _i683 < _list681.size; ++_i683)
          {
            _elem682 = new HBPulse();
            _elem682.read(iprot);
            struct.pulses.add(_elem682);
          }
        }
        struct.set_pulses_isSet(true);
      }
