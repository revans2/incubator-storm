            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<Pulse>(_list352.size);
                Pulse _elem353;
                for (int _i354 = 0; _i354 < _list352.size; ++_i354)
                {
                  _elem353 = new Pulse();
                  _elem353.read(iprot);
                  struct.pulses.add(_elem353);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (Pulse _iter355 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (Pulse _iter356 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<Pulse>(_list357.size);
          Pulse _elem358;
          for (int _i359 = 0; _i359 < _list357.size; ++_i359)
          {
            _elem358 = new Pulse();
            _elem358.read(iprot);
            struct.pulses.add(_elem358);
          }
        }
        struct.set_pulses_isSet(true);
      }
