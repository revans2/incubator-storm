            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<Pulse>(_list418.size);
                Pulse _elem419;
                for (int _i420 = 0; _i420 < _list418.size; ++_i420)
                {
                  _elem419 = new Pulse();
                  _elem419.read(iprot);
                  struct.pulses.add(_elem419);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (Pulse _iter421 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (Pulse _iter422 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<Pulse>(_list423.size);
          Pulse _elem424;
          for (int _i425 = 0; _i425 < _list423.size; ++_i425)
          {
            _elem424 = new Pulse();
            _elem424.read(iprot);
            struct.pulses.add(_elem424);
          }
        }
        struct.set_pulses_isSet(true);
      }
