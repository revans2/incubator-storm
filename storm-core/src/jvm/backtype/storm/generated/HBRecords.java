            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<Pulse>(_list536.size);
                Pulse _elem537;
                for (int _i538 = 0; _i538 < _list536.size; ++_i538)
                {
                  _elem537 = new Pulse();
                  _elem537.read(iprot);
                  struct.pulses.add(_elem537);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (Pulse _iter539 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (Pulse _iter540 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<Pulse>(_list541.size);
          Pulse _elem542;
          for (int _i543 = 0; _i543 < _list541.size; ++_i543)
          {
            _elem542 = new Pulse();
            _elem542.read(iprot);
            struct.pulses.add(_elem542);
          }
        }
        struct.set_pulses_isSet(true);
      }
