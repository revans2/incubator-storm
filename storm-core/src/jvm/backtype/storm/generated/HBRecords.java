            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list626.size);
                HBPulse _elem627;
                for (int _i628 = 0; _i628 < _list626.size; ++_i628)
                {
                  _elem627 = new HBPulse();
                  _elem627.read(iprot);
                  struct.pulses.add(_elem627);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (HBPulse _iter629 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (HBPulse _iter630 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list631.size);
          HBPulse _elem632;
          for (int _i633 = 0; _i633 < _list631.size; ++_i633)
          {
            _elem632 = new HBPulse();
            _elem632.read(iprot);
            struct.pulses.add(_elem632);
          }
        }
        struct.set_pulses_isSet(true);
      }
