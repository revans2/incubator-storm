            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list606.size);
                HBPulse _elem607;
                for (int _i608 = 0; _i608 < _list606.size; ++_i608)
                {
                  _elem607 = new HBPulse();
                  _elem607.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (HBPulse _iter609 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (HBPulse _iter610 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list611.size);
          HBPulse _elem612;
          for (int _i613 = 0; _i613 < _list611.size; ++_i613)
          {
            _elem612 = new HBPulse();
            _elem612.read(iprot);
