            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topo_ids = new ArrayList<String>(_list434.size);
                String _elem435;
                for (int _i436 = 0; _i436 < _list434.size; ++_i436)
                {
                  _elem435 = iprot.readString();
                  struct.topo_ids.add(_elem435);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyHistoryInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.topo_ids != null) {
        oprot.writeFieldBegin(TOPO_IDS_FIELD_DESC);
        {
          ...
          for (String _iter437 : struct.topo_ids)
          {
      ...
      if (struct.is_set_topo_ids()) {
        {
          ...
          for (String _iter438 : struct.topo_ids)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.topo_ids = new ArrayList<String>(_list439.size);
          String _elem440;
          for (int _i441 = 0; _i441 < _list439.size; ++_i441)
          {
            _elem440 = iprot.readString();
            struct.topo_ids.add(_elem440);
          }
        }
        struct.set_topo_ids_isSet(true);
      }
