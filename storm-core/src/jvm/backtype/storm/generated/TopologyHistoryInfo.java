            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topo_ids = new ArrayList<String>(_list478.size);
                String _elem479;
                for (int _i480 = 0; _i480 < _list478.size; ++_i480)
                {
                  _elem479 = iprot.readString();
                  struct.topo_ids.add(_elem479);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyHistoryInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.topo_ids != null) {
        oprot.writeFieldBegin(TOPO_IDS_FIELD_DESC);
        {
          ...
          for (String _iter481 : struct.topo_ids)
          {
      ...
      if (struct.is_set_topo_ids()) {
        {
          ...
          for (String _iter482 : struct.topo_ids)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.topo_ids = new ArrayList<String>(_list483.size);
          String _elem484;
          for (int _i485 = 0; _i485 < _list483.size; ++_i485)
          {
            _elem484 = iprot.readString();
            struct.topo_ids.add(_elem484);
          }
        }
        struct.set_topo_ids_isSet(true);
      }
