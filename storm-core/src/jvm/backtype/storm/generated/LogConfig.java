            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new HashMap<String,LogLevel>(2*_map428.size);
                String _key429;
                LogLevel _val430;
                for (int _i431 = 0; _i431 < _map428.size; ++_i431)
                {
                  _key429 = iprot.readString();
                  _val430 = new LogLevel();
                  _val430.read(iprot);
                  struct.named_logger_level.put(_key429, _val430);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.named_logger_level != null) {
        if (struct.is_set_named_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter432 : struct.named_logger_level.entrySet())
            {
      ...
      if (struct.is_set_named_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter433 : struct.named_logger_level.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map434.size);
          String _key435;
          LogLevel _val436;
          for (int _i437 = 0; _i437 < _map434.size; ++_i437)
          {
            _key435 = iprot.readString();
            _val436 = new LogLevel();
            _val436.read(iprot);
            struct.named_logger_level.put(_key435, _val436);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
