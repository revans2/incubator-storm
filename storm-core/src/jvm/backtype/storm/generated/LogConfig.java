            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new HashMap<String,LogLevel>(2*_map418.size);
                String _key419;
                LogLevel _val420;
                for (int _i421 = 0; _i421 < _map418.size; ++_i421)
                {
                  _key419 = iprot.readString();
                  _val420 = new LogLevel();
                  _val420.read(iprot);
                  struct.named_logger_level.put(_key419, _val420);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.named_logger_level != null) {
        if (struct.is_set_named_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter422 : struct.named_logger_level.entrySet())
            {
      ...
      if (struct.is_set_named_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter423 : struct.named_logger_level.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map424.size);
          String _key425;
          LogLevel _val426;
          for (int _i427 = 0; _i427 < _map424.size; ++_i427)
          {
            _key425 = iprot.readString();
            _val426 = new LogLevel();
            _val426.read(iprot);
            struct.named_logger_level.put(_key425, _val426);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
