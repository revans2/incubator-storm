            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new HashMap<String,LogLevel>(2*_map468.size);
                String _key469;
                LogLevel _val470;
                for (int _i471 = 0; _i471 < _map468.size; ++_i471)
                {
                  _key469 = iprot.readString();
                  _val470 = new LogLevel();
                  _val470.read(iprot);
                  struct.named_logger_level.put(_key469, _val470);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.named_logger_level != null) {
        if (struct.is_set_named_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter472 : struct.named_logger_level.entrySet())
            {
      ...
      if (struct.is_set_named_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter473 : struct.named_logger_level.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map474.size);
          String _key475;
          LogLevel _val476;
          for (int _i477 = 0; _i477 < _map474.size; ++_i477)
          {
            _key475 = iprot.readString();
            _val476 = new LogLevel();
            _val476.read(iprot);
            struct.named_logger_level.put(_key475, _val476);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
