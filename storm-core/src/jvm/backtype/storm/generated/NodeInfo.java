            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set482.size);
                long _elem483;
                for (int _i484 = 0; _i484 < _set482.size; ++_i484)
                {
                  _elem483 = iprot.readI64();
                  struct.port.add(_elem483);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        ...
        struct.port = new HashSet<Long>(2*_set487.size);
        long _elem488;
        for (int _i489 = 0; _i489 < _set487.size; ++_i489)
        {
          _elem488 = iprot.readI64();
          struct.port.add(_elem488);
        }
      }
      struct.set_port_isSet(true);
    }
