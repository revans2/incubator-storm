...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set462.size);
                long _elem463;
                for (int _i464 = 0; _i464 < _set462.size; ++_i464)
                {
                  _elem463 = iprot.readI64();
                  struct.port.add(_elem463);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        org.apache.thrift.protocol.TSet _set467 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set467.size);
        long _elem468;
        for (int _i469 = 0; _i469 < _set467.size; ++_i469)
        {
          _elem468 = iprot.readI64();
          struct.port.add(_elem468);
        }
      }
      struct.set_port_isSet(true);
    }
