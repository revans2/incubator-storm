...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map470.size);
                String _key471;
                String _val472;
                for (int _i473 = 0; _i473 < _map470.size; ++_i473)
                {
                  ...
                  struct.node_host.put(_key471, _val472);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map474.size);
                List<Long> _key475;
                NodeInfo _val476;
                ...
                {
                  {
                    ...
                    _key475 = new ArrayList<Long>(_list478.size);
                    long _elem479;
                    for (int _i480 = 0; _i480 < _list478.size; ++_i480)
                    {
                      _elem479 = iprot.readI64();
                      _key475.add(_elem479);
                    }
                    iprot.readListEnd();
                  }
                  _val476 = new NodeInfo();
                  _val476.read(iprot);
                  struct.executor_node_port.put(_key475, _val476);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map481.size);
                List<Long> _key482;
                long _val483;
                ...
                {
                  {
                    ...
                    _key482 = new ArrayList<Long>(_list485.size);
                    long _elem486;
                    for (int _i487 = 0; _i487 < _list485.size; ++_i487)
                    {
                      _elem486 = iprot.readI64();
                      _key482.add(_elem486);
                    }
                    iprot.readListEnd();
                  }
                  _val483 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key482, _val483);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.node_host != null) {
        if (struct.is_set_node_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter488 : struct.node_host.entrySet())
            {
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter489 : struct.executor_node_port.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter489.getKey().size()));
                for (long _iter490 : _iter489.getKey())
                {
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter491 : struct.executor_start_time_secs.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter491.getKey().size()));
                for (long _iter492 : _iter491.getKey())
                {
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter493 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter494 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter494.getKey().size());
              for (long _iter495 : _iter494.getKey())
              {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter496 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter496.getKey().size());
              for (long _iter497 : _iter496.getKey())
              {
                oprot.writeI64(_iter497);
              }
            }
            oprot.writeI64(_iter496.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.node_host = new HashMap<String,String>(2*_map498.size);
          String _key499;
          String _val500;
          for (int _i501 = 0; _i501 < _map498.size; ++_i501)
          {
            ...
            struct.node_host.put(_key499, _val500);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map502 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map502.size);
          List<Long> _key503;
          NodeInfo _val504;
          for (int _i505 = 0; _i505 < _map502.size; ++_i505)
          {
            {
              org.apache.thrift.protocol.TList _list506 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key503 = new ArrayList<Long>(_list506.size);
              long _elem507;
              for (int _i508 = 0; _i508 < _list506.size; ++_i508)
              {
                _elem507 = iprot.readI64();
                _key503.add(_elem507);
              }
            }
            _val504 = new NodeInfo();
            _val504.read(iprot);
            struct.executor_node_port.put(_key503, _val504);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map509 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map509.size);
          List<Long> _key510;
          long _val511;
          ...
          {
            {
              ...
              _key510 = new ArrayList<Long>(_list513.size);
              long _elem514;
              for (int _i515 = 0; _i515 < _list513.size; ++_i515)
              {
                _elem514 = iprot.readI64();
                _key510.add(_elem514);
              }
            }
            _val511 = iprot.readI64();
            struct.executor_start_time_secs.put(_key510, _val511);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
