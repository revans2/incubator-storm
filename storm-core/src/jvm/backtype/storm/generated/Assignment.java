...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map490.size);
                String _key491;
                String _val492;
                for (int _i493 = 0; _i493 < _map490.size; ++_i493)
                {
                  ...
                  struct.node_host.put(_key491, _val492);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map494.size);
                List<Long> _key495;
                NodeInfo _val496;
                ...
                {
                  {
                    ...
                    _key495 = new ArrayList<Long>(_list498.size);
                    long _elem499;
                  ...
                  _val496 = new NodeInfo();
                  _val496.read(iprot);
                  struct.executor_node_port.put(_key495, _val496);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map501.size);
                List<Long> _key502;
                long _val503;
                ...
                {
                  {
                    ...
                    _key502 = new ArrayList<Long>(_list505.size);
                    long _elem506;
                    for (int _i507 = 0; _i507 < _list505.size; ++_i507)
                    {
                      _elem506 = iprot.readI64();
                      _key502.add(_elem506);
                    }
                    iprot.readListEnd();
                  }
                  _val503 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key502, _val503);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.node_host != null) {
        if (struct.is_set_node_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter508 : struct.node_host.entrySet())
            {
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter509 : struct.executor_node_port.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter509.getKey().size()));
                for (long _iter510 : _iter509.getKey())
                {
                  oprot.writeI64(_iter510);
                }
                oprot.writeListEnd();
              }
              _iter509.getValue().write(oprot);
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter511 : struct.executor_start_time_secs.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter511.getKey().size()));
                for (long _iter512 : _iter511.getKey())
                {
                  oprot.writeI64(_iter512);
                }
                oprot.writeListEnd();
              }
              oprot.writeI64(_iter511.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter513 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter514 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter514.getKey().size());
              for (long _iter515 : _iter514.getKey())
              {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter516 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter516.getKey().size());
              for (long _iter517 : _iter516.getKey())
              {
                oprot.writeI64(_iter517);
              }
            }
            oprot.writeI64(_iter516.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.node_host = new HashMap<String,String>(2*_map518.size);
          String _key519;
          String _val520;
          for (int _i521 = 0; _i521 < _map518.size; ++_i521)
          {
            ...
            struct.node_host.put(_key519, _val520);
          }
        }
        struct.set_node_host_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map522 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map522.size);
          List<Long> _key523;
          NodeInfo _val524;
          ...
          {
            {
              ...
              _key523 = new ArrayList<Long>(_list526.size);
              long _elem527;
              for (int _i528 = 0; _i528 < _list526.size; ++_i528)
              {
                _elem527 = iprot.readI64();
                _key523.add(_elem527);
              }
            }
            _val524 = new NodeInfo();
            _val524.read(iprot);
            struct.executor_node_port.put(_key523, _val524);
          }
        }
        struct.set_executor_node_port_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map529 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map529.size);
          List<Long> _key530;
          long _val531;
          for (int _i532 = 0; _i532 < _map529.size; ++_i532)
          {
            {
              org.apache.thrift.protocol.TList _list533 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
              _key530 = new ArrayList<Long>(_list533.size);
              long _elem534;
            ...
            struct.executor_start_time_secs.put(_key530, _val531);
          }
        }
        struct.set_executor_start_time_secs_isSet(true);
      }
