...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map520.size);
                String _key521;
                String _val522;
                for (int _i523 = 0; _i523 < _map520.size; ++_i523)
                {
                  ...
                  struct.node_host.put(_key521, _val522);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map524.size);
                List<Long> _key525;
                NodeInfo _val526;
                ...
                {
                  {
                    ...
                    _key525 = new ArrayList<Long>(_list528.size);
                    long _elem529;
                  ...
                  _val526 = new NodeInfo();
                  _val526.read(iprot);
                  struct.executor_node_port.put(_key525, _val526);
                }
                iprot.readMapEnd();
              }
          ...
          case 4: // EXECUTOR_START_TIME_SECS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map531 = iprot.readMapBegin();
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map531.size);
                List<Long> _key532;
                long _val533;
                ...
                {
                  {
                    ...
                    _key532 = new ArrayList<Long>(_list535.size);
                    long _elem536;
                    for (int _i537 = 0; _i537 < _list535.size; ++_i537)
                    {
                      _elem536 = iprot.readI64();
                      _key532.add(_elem536);
                    }
                    iprot.readListEnd();
                  }
                  _val533 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key532, _val533);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.node_host != null) {
        if (struct.is_set_node_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter538 : struct.node_host.entrySet())
            {
      ...
      if (struct.executor_node_port != null) {
        if (struct.is_set_executor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter539 : struct.executor_node_port.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter539.getKey().size()));
                for (long _iter540 : _iter539.getKey())
                {
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.is_set_executor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter541 : struct.executor_start_time_secs.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter541.getKey().size()));
                for (long _iter542 : _iter541.getKey())
                {
                  oprot.writeI64(_iter542);
                }
                oprot.writeListEnd();
              }
              oprot.writeI64(_iter541.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.is_set_node_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter543 : struct.node_host.entrySet())
          {
      ...
      if (struct.is_set_executor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter544 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter544.getKey().size());
              for (long _iter545 : _iter544.getKey())
              {
      ...
      if (struct.is_set_executor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter546 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter546.getKey().size());
              for (long _iter547 : _iter546.getKey())
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map552 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          ...
          {
            {
              org.apache.thrift.protocol.TList _list556 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map559 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
