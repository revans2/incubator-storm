            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map566.size);
                String _key567;
                int _val568;
                for (int _i569 = 0; _i569 < _map566.size; ++_i569)
                {
                  ...
                  struct.component_executors.put(_key567, _val568);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter570 : struct.component_executors.entrySet())
            {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter571 : struct.component_executors.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_executors = new HashMap<String,Integer>(2*_map572.size);
          String _key573;
          int _val574;
          for (int _i575 = 0; _i575 < _map572.size; ++_i575)
          {
            ...
            struct.component_executors.put(_key573, _val574);
          }
        }
        struct.set_component_executors_isSet(true);
      }
