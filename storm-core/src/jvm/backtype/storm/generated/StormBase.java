...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map536.size);
                String _key537;
                int _val538;
                for (int _i539 = 0; _i539 < _map536.size; ++_i539)
                {
                  ...
                  struct.component_executors.put(_key537, _val538);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter540 : struct.component_executors.entrySet())
            {
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter541 : struct.component_executors.entrySet())
          {
            oprot.writeString(_iter541.getKey());
            oprot.writeI32(_iter541.getValue());
          }
        }
      }
      if (struct.is_set_launch_time_secs()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map542 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map542.size);
          String _key543;
          int _val544;
          for (int _i545 = 0; _i545 < _map542.size; ++_i545)
          {
            _key543 = iprot.readString();
            _val544 = iprot.readI32();
            struct.component_executors.put(_key543, _val544);
          }
        }
        struct.set_component_executors_isSet(true);
      }
