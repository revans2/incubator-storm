            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map516.size);
                String _key517;
                int _val518;
                for (int _i519 = 0; _i519 < _map516.size; ++_i519)
                {
                  ...
                  struct.component_executors.put(_key517, _val518);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter520 : struct.component_executors.entrySet())
            {
              oprot.writeString(_iter520.getKey());
              oprot.writeI32(_iter520.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter521 : struct.component_executors.entrySet())
          {
            oprot.writeString(_iter521.getKey());
            oprot.writeI32(_iter521.getValue());
          }
        }
      }
      if (struct.is_set_launch_time_secs()) {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.component_executors = new HashMap<String,Integer>(2*_map522.size);
          String _key523;
          int _val524;
          for (int _i525 = 0; _i525 < _map522.size; ++_i525)
          {
            ...
            struct.component_executors.put(_key523, _val524);
          }
        }
        struct.set_component_executors_isSet(true);
      }
