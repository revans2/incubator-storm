            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map586.size);
                String _key587;
                int _val588;
                for (int _i589 = 0; _i589 < _map586.size; ++_i589)
                {
                  _key587 = iprot.readString();
                  _val588 = iprot.readI32();
                  struct.component_executors.put(_key587, _val588);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter591 : struct.component_executors.entrySet())
          {
