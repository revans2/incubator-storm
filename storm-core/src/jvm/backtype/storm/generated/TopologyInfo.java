...
public class TopologyInfo implements org.apache.thrift.TBase<TopologyInfo, TopologyInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyInfo> {
  ...
  private static final org.apache.thrift.protocol.TField SCHEDULER_FIELD_DESC = new org.apache.thrift.protocol.TField("scheduler", org.apache.thrift.protocol.TType.STRING, (short)515);
  ...
  private static final int __REQUESTED_MEMONHEAP_ISSET_ID = 1;
  private static final int __REQUESTED_MEMOFFHEAP_ISSET_ID = 2;
  private static final int __REQUESTED_CPU_ISSET_ID = 3;
  private static final int __ASSIGNED_MEMONHEAP_ISSET_ID = 4;
  private static final int __ASSIGNED_MEMOFFHEAP_ISSET_ID = 5;
  private static final int __ASSIGNED_CPU_ISSET_ID = 6;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.SCHED_STATUS,_Fields.OWNER,_Fields.SCHEDULER,_Fields.REQUESTED_MEMONHEAP,_Fields.REQUESTED_MEMOFFHEAP,_Fields.REQUESTED_CPU,_Fields.ASSIGNED_MEMONHEAP,_Fields.ASSIGNED_MEMOFFHEAP,_Fields.ASSIGNED_CPU};
  ...
  public void set_scheduler(String scheduler) {
    this.scheduler = scheduler;
  }

  public void unset_scheduler() {
    this.scheduler = null;
  }

  /** Returns true if field scheduler is set (has been assigned a value) and false otherwise */
  public boolean is_set_scheduler() {
    return this.scheduler != null;
  }

  public void set_scheduler_isSet(boolean value) {
    if (!value) {
      this.scheduler = null;
    }
  }
  ...
  public boolean equals(TopologyInfo that) {
    ...
    boolean this_present_scheduler = true && this.is_set_scheduler();
    boolean that_present_scheduler = true && that.is_set_scheduler();
  ...
  public int hashCode() {
    ...
    boolean present_scheduler = true && (is_set_scheduler());
  ...
  public int compareTo(TopologyInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_scheduler()).compareTo(other.is_set_scheduler());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_scheduler()) {
        ...
        switch (schemeField.id) {
          ...
          case 515: // SCHEDULER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              ...
              struct.set_scheduler_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
