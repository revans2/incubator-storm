...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2015-4-28")
public class TopologyPageInfo implements org.apache.thrift.TBase<TopologyPageInfo, TopologyPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyPageInfo> {
  ...
  private List<SpoutAggregateStats> spout_agg_stats; // optional
  private List<BoltAggregateStats> bolt_agg_stats; // optional
  ...
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.UPTIME_SECS,_Fields.STATUS,_Fields.NUM_TASKS,_Fields.NUM_WORKERS,_Fields.NUM_EXECUTORS,_Fields.TOPOLOGY_CONF,_Fields.SPOUT_AGG_STATS,_Fields.BOLT_AGG_STATS,_Fields.SCHED_STATUS,_Fields.TOPOLOGY_STATS,_Fields.OWNER};
  ...
  public TopologyPageInfo(TopologyPageInfo other) {
    ...
    if (other.is_set_spout_agg_stats()) {
      List<SpoutAggregateStats> __this__spout_agg_stats = new ArrayList<SpoutAggregateStats>(other.spout_agg_stats.size());
    ...
    if (other.is_set_bolt_agg_stats()) {
      List<BoltAggregateStats> __this__bolt_agg_stats = new ArrayList<BoltAggregateStats>(other.bolt_agg_stats.size());
  ...
  public int hashCode() {
    ...
    list.add(present_spout_agg_stats);
    if (present_spout_agg_stats)
      list.add(spout_agg_stats);

    boolean present_bolt_agg_stats = true && (is_set_bolt_agg_stats());
    list.add(present_bolt_agg_stats);
    if (present_bolt_agg_stats)
      list.add(bolt_agg_stats);
  ...
  public int compareTo(TopologyPageInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_spout_agg_stats()).compareTo(other.is_set_spout_agg_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_spout_agg_stats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.spout_agg_stats, other.spout_agg_stats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(is_set_bolt_agg_stats()).compareTo(other.is_set_bolt_agg_stats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_bolt_agg_stats()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bolt_agg_stats, other.bolt_agg_stats);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TopologyPageInfoStandardScheme extends StandardScheme<TopologyPageInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spout_agg_stats = new ArrayList<SpoutAggregateStats>(_list366.size);
                SpoutAggregateStats _elem367;
                for (int _i368 = 0; _i368 < _list366.size; ++_i368)
                {
                  _elem367 = new SpoutAggregateStats();
                  _elem367.read(iprot);
                  struct.spout_agg_stats.add(_elem367);
                }
                iprot.readListEnd();
              }
              struct.set_spout_agg_stats_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bolt_agg_stats = new ArrayList<BoltAggregateStats>(_list369.size);
                BoltAggregateStats _elem370;
                for (int _i371 = 0; _i371 < _list369.size; ++_i371)
                {
                  _elem370 = new BoltAggregateStats();
                  _elem370.read(iprot);
                  struct.bolt_agg_stats.add(_elem370);
                }
                iprot.readListEnd();
              }
              struct.set_bolt_agg_stats_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.spout_agg_stats != null) {
        if (struct.is_set_spout_agg_stats()) {
          oprot.writeFieldBegin(SPOUT_AGG_STATS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.spout_agg_stats.size()));
            for (SpoutAggregateStats _iter372 : struct.spout_agg_stats)
            {
      ...
      if (struct.bolt_agg_stats != null) {
        if (struct.is_set_bolt_agg_stats()) {
          oprot.writeFieldBegin(BOLT_AGG_STATS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.bolt_agg_stats.size()));
            for (BoltAggregateStats _iter373 : struct.bolt_agg_stats)
            {
  ...
  private static class TopologyPageInfoTupleScheme extends TupleScheme<TopologyPageInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TopologyPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.is_set_spout_agg_stats()) {
        {
          oprot.writeI32(struct.spout_agg_stats.size());
          for (SpoutAggregateStats _iter374 : struct.spout_agg_stats)
          {
      ...
      if (struct.is_set_bolt_agg_stats()) {
        {
          oprot.writeI32(struct.bolt_agg_stats.size());
          for (BoltAggregateStats _iter375 : struct.bolt_agg_stats)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.spout_agg_stats = new ArrayList<SpoutAggregateStats>(_list376.size);
          SpoutAggregateStats _elem377;
          for (int _i378 = 0; _i378 < _list376.size; ++_i378)
          {
            _elem377 = new SpoutAggregateStats();
            _elem377.read(iprot);
            struct.spout_agg_stats.add(_elem377);
          }
        }
        struct.set_spout_agg_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.bolt_agg_stats = new ArrayList<BoltAggregateStats>(_list379.size);
          BoltAggregateStats _elem380;
          for (int _i381 = 0; _i381 < _list379.size; ++_i381)
          {
            _elem380 = new BoltAggregateStats();
            _elem380.read(iprot);
            struct.bolt_agg_stats.add(_elem380);
          }
        }
        struct.set_bolt_agg_stats_isSet(true);
      }
