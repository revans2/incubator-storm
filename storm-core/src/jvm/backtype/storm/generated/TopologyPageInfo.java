...
public class TopologyPageInfo implements org.apache.thrift.TBase<TopologyPageInfo, TopologyPageInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyPageInfo> {
  ...
  private static final org.apache.thrift.protocol.TField REQUESTED_MEMONHEAP_FIELD_DESC = new org.apache.thrift.protocol.TField("requested_memonheap", org.apache.thrift.protocol.TType.DOUBLE, (short)520);
  private static final org.apache.thrift.protocol.TField REQUESTED_MEMOFFHEAP_FIELD_DESC = new org.apache.thrift.protocol.TField("requested_memoffheap", org.apache.thrift.protocol.TType.DOUBLE, (short)521);
  private static final org.apache.thrift.protocol.TField REQUESTED_CPU_FIELD_DESC = new org.apache.thrift.protocol.TField("requested_cpu", org.apache.thrift.protocol.TType.DOUBLE, (short)522);
  private static final org.apache.thrift.protocol.TField ASSIGNED_MEMONHEAP_FIELD_DESC = new org.apache.thrift.protocol.TField("assigned_memonheap", org.apache.thrift.protocol.TType.DOUBLE, (short)530);
  private static final org.apache.thrift.protocol.TField ASSIGNED_MEMOFFHEAP_FIELD_DESC = new org.apache.thrift.protocol.TField("assigned_memoffheap", org.apache.thrift.protocol.TType.DOUBLE, (short)531);
  private static final org.apache.thrift.protocol.TField ASSIGNED_CPU_FIELD_DESC = new org.apache.thrift.protocol.TField("assigned_cpu", org.apache.thrift.protocol.TType.DOUBLE, (short)532);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    REQUESTED_MEMONHEAP((short)520, "requested_memonheap"),
    REQUESTED_MEMOFFHEAP((short)521, "requested_memoffheap"),
    REQUESTED_CPU((short)522, "requested_cpu"),
    ASSIGNED_MEMONHEAP((short)530, "assigned_memonheap"),
    ASSIGNED_MEMOFFHEAP((short)531, "assigned_memoffheap"),
    ASSIGNED_CPU((short)532, "assigned_cpu");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 13: // OWNER
          return OWNER;
        case 520: // REQUESTED_MEMONHEAP
          return REQUESTED_MEMONHEAP;
        case 521: // REQUESTED_MEMOFFHEAP
          return REQUESTED_MEMOFFHEAP;
        case 522: // REQUESTED_CPU
          return REQUESTED_CPU;
        case 530: // ASSIGNED_MEMONHEAP
          return ASSIGNED_MEMONHEAP;
        case 531: // ASSIGNED_MEMOFFHEAP
          return ASSIGNED_MEMOFFHEAP;
        case 532: // ASSIGNED_CPU
          return ASSIGNED_CPU;
        default:
          return null;
      }
  ...
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.UPTIME_SECS,_Fields.STATUS,_Fields.NUM_TASKS,_Fields.NUM_WORKERS,_Fields.NUM_EXECUTORS,_Fields.TOPOLOGY_CONF,_Fields.ID_TO_SPOUT_AGG_STATS,_Fields.ID_TO_BOLT_AGG_STATS,_Fields.SCHED_STATUS,_Fields.TOPOLOGY_STATS,_Fields.OWNER,_Fields.REQUESTED_MEMONHEAP,_Fields.REQUESTED_MEMOFFHEAP,_Fields.REQUESTED_CPU,_Fields.ASSIGNED_MEMONHEAP,_Fields.ASSIGNED_MEMOFFHEAP,_Fields.ASSIGNED_CPU};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.id_to_spout_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map376.size);
                String _key377;
                ComponentAggregateStats _val378;
                for (int _i379 = 0; _i379 < _map376.size; ++_i379)
                {
                  _key377 = iprot.readString();
                  _val378 = new ComponentAggregateStats();
                  _val378.read(iprot);
                  struct.id_to_spout_agg_stats.put(_key377, _val378);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.id_to_bolt_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map380.size);
                String _key381;
                ComponentAggregateStats _val382;
                for (int _i383 = 0; _i383 < _map380.size; ++_i383)
                {
                  _key381 = iprot.readString();
                  _val382 = new ComponentAggregateStats();
                  _val382.read(iprot);
                  struct.id_to_bolt_agg_stats.put(_key381, _val382);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.id_to_spout_agg_stats != null) {
        if (struct.is_set_id_to_spout_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_SPOUT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter384 : struct.id_to_spout_agg_stats.entrySet())
            {
      ...
      if (struct.id_to_bolt_agg_stats != null) {
        if (struct.is_set_id_to_bolt_agg_stats()) {
          oprot.writeFieldBegin(ID_TO_BOLT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, ComponentAggregateStats> _iter385 : struct.id_to_bolt_agg_stats.entrySet())
            {
  ...
  private static class TopologyPageInfoTupleScheme extends TupleScheme<TopologyPageInfo> {
      ...
      if (struct.is_set_id_to_spout_agg_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter386 : struct.id_to_spout_agg_stats.entrySet())
          {
      ...
      if (struct.is_set_id_to_bolt_agg_stats()) {
        {
          ...
          for (Map.Entry<String, ComponentAggregateStats> _iter387 : struct.id_to_bolt_agg_stats.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyPageInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map388 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.id_to_spout_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map388.size);
          String _key389;
          ...
          for (int _i391 = 0; _i391 < _map388.size; ++_i391)
          {
            ...
            _val390.read(iprot);
            struct.id_to_spout_agg_stats.put(_key389, _val390);
          }
        }
        struct.set_id_to_spout_agg_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.id_to_bolt_agg_stats = new HashMap<String,ComponentAggregateStats>(2*_map392.size);
          String _key393;
          ComponentAggregateStats _val394;
          for (int _i395 = 0; _i395 < _map392.size; ++_i395)
          {
            _key393 = iprot.readString();
            _val394 = new ComponentAggregateStats();
            _val394.read(iprot);
            struct.id_to_bolt_agg_stats.put(_key393, _val394);
          }
        }
        struct.set_id_to_bolt_agg_stats_isSet(true);
      }
