      ...
      if (struct.spout_agg_stats != null) {
        if (struct.is_set_spout_agg_stats()) {
          oprot.writeFieldBegin(SPOUT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (SpoutAggregateStats _iter382 : struct.spout_agg_stats)
            {
      ...
      if (struct.bolt_agg_stats != null) {
        if (struct.is_set_bolt_agg_stats()) {
          oprot.writeFieldBegin(BOLT_AGG_STATS_FIELD_DESC);
          {
            ...
            for (BoltAggregateStats _iter383 : struct.bolt_agg_stats)
            {
      ...
      if (struct.is_set_spout_agg_stats()) {
        {
          ...
          for (SpoutAggregateStats _iter384 : struct.spout_agg_stats)
          {
      ...
      if (struct.is_set_bolt_agg_stats()) {
        {
          ...
          for (BoltAggregateStats _iter385 : struct.bolt_agg_stats)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.spout_agg_stats = new ArrayList<SpoutAggregateStats>(_list386.size);
          SpoutAggregateStats _elem387;
          for (int _i388 = 0; _i388 < _list386.size; ++_i388)
          {
            _elem387 = new SpoutAggregateStats();
            _elem387.read(iprot);
            struct.spout_agg_stats.add(_elem387);
          }
        }
        struct.set_spout_agg_stats_isSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.bolt_agg_stats = new ArrayList<BoltAggregateStats>(_list389.size);
          BoltAggregateStats _elem390;
          for (int _i391 = 0; _i391 < _list389.size; ++_i391)
          {
            _elem390 = new BoltAggregateStats();
            _elem390.read(iprot);
            struct.bolt_agg_stats.add(_elem390);
          }
        }
        struct.set_bolt_agg_stats_isSet(true);
      }
