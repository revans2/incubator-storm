        ...
        switch (schemeField.id) {
          ...
          case 2: // EXECUTOR_STATS
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                org.apache.thrift.protocol.TMap _map526 = iprot.readMapBegin();
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map526.size);
                ExecutorInfo _key527;
                ExecutorStats _val528;
                for (int _i529 = 0; _i529 < _map526.size; ++_i529)
                {
                  _key527 = new ExecutorInfo();
                  _key527.read(iprot);
                  _val528 = new ExecutorStats();
                  _val528.read(iprot);
                  struct.executor_stats.put(_key527, _val528);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter530 : struct.executor_stats.entrySet())
          {
            _iter530.getKey().write(oprot);
            _iter530.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter531 : struct.executor_stats.entrySet())
        {
          _iter531.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map532 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map532.size);
        ExecutorInfo _key533;
        ExecutorStats _val534;
        for (int _i535 = 0; _i535 < _map532.size; ++_i535)
        {
          _key533 = new ExecutorInfo();
          _key533.read(iprot);
          _val534 = new ExecutorStats();
          _val534.read(iprot);
          struct.executor_stats.put(_key533, _val534);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
