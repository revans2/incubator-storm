            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map546.size);
                ExecutorInfo _key547;
                ExecutorStats _val548;
                for (int _i549 = 0; _i549 < _map546.size; ++_i549)
                {
                  _key547 = new ExecutorInfo();
                  _key547.read(iprot);
                  _val548 = new ExecutorStats();
                  _val548.read(iprot);
                  struct.executor_stats.put(_key547, _val548);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter550 : struct.executor_stats.entrySet())
          {
            _iter550.getKey().write(oprot);
            _iter550.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter551 : struct.executor_stats.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map552 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map552.size);
        ExecutorInfo _key553;
        ExecutorStats _val554;
        for (int _i555 = 0; _i555 < _map552.size; ++_i555)
        {
          _key553 = new ExecutorInfo();
          _key553.read(iprot);
          _val554 = new ExecutorStats();
          _val554.read(iprot);
          struct.executor_stats.put(_key553, _val554);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
