            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<String>(_list632.size);
                String _elem633;
                for (int _i634 = 0; _i634 < _list632.size; ++_i634)
                {
                  _elem633 = iprot.readString();
                  struct.users.add(_elem633);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.groups = new ArrayList<String>(_list635.size);
                String _elem636;
                for (int _i637 = 0; _i637 < _list635.size; ++_i637)
                {
                  _elem636 = iprot.readString();
                  struct.groups.add(_elem636);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      if (struct.users != null) {
        oprot.writeFieldBegin(USERS_FIELD_DESC);
        {
          ...
          for (String _iter638 : struct.users)
          {
      ...
      if (struct.groups != null) {
        oprot.writeFieldBegin(GROUPS_FIELD_DESC);
        {
          ...
          for (String _iter639 : struct.groups)
          {
  ...
  private static class LSTopoHistoryTupleScheme extends TupleScheme<LSTopoHistory> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.time_stamp);
      {
        ...
        for (String _iter640 : struct.users)
        {
      ...
      }
      {
        ...
        for (String _iter641 : struct.groups)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      struct.set_time_stamp_isSet(true);
      {
        ...
        struct.users = new ArrayList<String>(_list642.size);
        String _elem643;
        for (int _i644 = 0; _i644 < _list642.size; ++_i644)
        {
          _elem643 = iprot.readString();
          struct.users.add(_elem643);
        }
      }
      struct.set_users_isSet(true);
      {
        ...
        struct.groups = new ArrayList<String>(_list645.size);
        String _elem646;
        for (int _i647 = 0; _i647 < _list645.size; ++_i647)
        {
          _elem646 = iprot.readString();
          struct.groups.add(_elem646);
        }
      }
      struct.set_groups_isSet(true);
    }
