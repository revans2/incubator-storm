            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<String>(_list582.size);
                String _elem583;
                for (int _i584 = 0; _i584 < _list582.size; ++_i584)
                {
                  _elem583 = iprot.readString();
                  struct.users.add(_elem583);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.groups = new ArrayList<String>(_list585.size);
                String _elem586;
                for (int _i587 = 0; _i587 < _list585.size; ++_i587)
                {
                  _elem586 = iprot.readString();
                  struct.groups.add(_elem586);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      if (struct.users != null) {
        oprot.writeFieldBegin(USERS_FIELD_DESC);
        {
          ...
          for (String _iter588 : struct.users)
          {
      ...
      if (struct.groups != null) {
        oprot.writeFieldBegin(GROUPS_FIELD_DESC);
        {
          ...
          for (String _iter589 : struct.groups)
          {
  ...
  private static class LSTopoHistoryTupleScheme extends TupleScheme<LSTopoHistory> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.time_stamp);
      {
        ...
        for (String _iter590 : struct.users)
        {
      ...
      }
      {
        ...
        for (String _iter591 : struct.groups)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      struct.set_time_stamp_isSet(true);
      {
        ...
        struct.users = new ArrayList<String>(_list592.size);
        String _elem593;
        for (int _i594 = 0; _i594 < _list592.size; ++_i594)
        {
          _elem593 = iprot.readString();
          struct.users.add(_elem593);
        }
      }
      struct.set_users_isSet(true);
      {
        ...
        struct.groups = new ArrayList<String>(_list595.size);
        String _elem596;
        for (int _i597 = 0; _i597 < _list595.size; ++_i597)
        {
          _elem596 = iprot.readString();
          struct.groups.add(_elem596);
        }
      }
      struct.set_groups_isSet(true);
    }
