            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new ArrayList<String>(_list602.size);
                String _elem603;
                for (int _i604 = 0; _i604 < _list602.size; ++_i604)
                {
                  _elem603 = iprot.readString();
                  struct.users.add(_elem603);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.groups = new ArrayList<String>(_list605.size);
                String _elem606;
                for (int _i607 = 0; _i607 < _list605.size; ++_i607)
                {
                  _elem606 = iprot.readString();
                  struct.groups.add(_elem606);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      if (struct.users != null) {
        oprot.writeFieldBegin(USERS_FIELD_DESC);
        {
          ...
          for (String _iter608 : struct.users)
          {
      ...
      if (struct.groups != null) {
        oprot.writeFieldBegin(GROUPS_FIELD_DESC);
        {
          ...
          for (String _iter609 : struct.groups)
          {
  ...
  private static class LSTopoHistoryTupleScheme extends TupleScheme<LSTopoHistory> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.time_stamp);
      {
        ...
        for (String _iter610 : struct.users)
        {
      ...
      }
      {
        ...
        for (String _iter611 : struct.groups)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSTopoHistory struct) throws org.apache.thrift.TException {
      ...
      struct.set_time_stamp_isSet(true);
      {
        org.apache.thrift.protocol.TList _list612 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
        struct.users = new ArrayList<String>(_list612.size);
        String _elem613;
        for (int _i614 = 0; _i614 < _list612.size; ++_i614)
        {
          _elem613 = iprot.readString();
          struct.users.add(_elem613);
        }
      }
      struct.set_users_isSet(true);
      {
        ...
        struct.groups = new ArrayList<String>(_list615.size);
        String _elem616;
        for (int _i617 = 0; _i617 < _list615.size; ++_i617)
        {
          _elem616 = iprot.readString();
          struct.groups.add(_elem616);
        }
      }
      struct.set_groups_isSet(true);
    }
