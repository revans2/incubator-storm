            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map536.size);
                String _key537;
                ThriftSerializedObject _val538;
                for (int _i539 = 0; _i539 < _map536.size; ++_i539)
                {
                  _key537 = iprot.readString();
                  _val538 = new ThriftSerializedObject();
                  _val538.read(iprot);
                  struct.serialized_parts.put(_key537, _val538);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter540 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter541 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map542 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map542.size);
        String _key543;
        ThriftSerializedObject _val544;
        for (int _i545 = 0; _i545 < _map542.size; ++_i545)
        {
          _key543 = iprot.readString();
          _val544 = new ThriftSerializedObject();
          _val544.read(iprot);
          struct.serialized_parts.put(_key543, _val544);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
