            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map556.size);
                String _key557;
                ThriftSerializedObject _val558;
                for (int _i559 = 0; _i559 < _map556.size; ++_i559)
                {
                  _key557 = iprot.readString();
                  _val558 = new ThriftSerializedObject();
                  _val558.read(iprot);
                  struct.serialized_parts.put(_key557, _val558);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter560 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter561 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map562.size);
        String _key563;
        ThriftSerializedObject _val564;
        for (int _i565 = 0; _i565 < _map562.size; ++_i565)
        {
          _key563 = iprot.readString();
          _val564 = new ThriftSerializedObject();
          _val564.read(iprot);
          struct.serialized_parts.put(_key563, _val564);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
