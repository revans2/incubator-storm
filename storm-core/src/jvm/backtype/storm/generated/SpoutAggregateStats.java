...
public class SpoutAggregateStats implements org.apache.thrift.TBase<SpoutAggregateStats, SpoutAggregateStats._Fields>, java.io.Serializable, Cloneable {
  ...
  private double complete_latency; // required
  ...
  public void unset_complete_latency() {
    __isset_bit_vector.clear(__COMPLETE_LATENCY_ISSET_ID);
  }
  ...
  public boolean is_set_complete_latency() {
    return __isset_bit_vector.get(__COMPLETE_LATENCY_ISSET_ID);
  }

  public void set_complete_latency_isSet(boolean value) {
    __isset_bit_vector.set(__COMPLETE_LATENCY_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_complete_latency);
    if (present_complete_latency)
      builder.append(complete_latency);
  ...
  public int compareTo(SpoutAggregateStats other) {
    ...
    lastComparison = Boolean.valueOf(is_set_complete_latency()).compareTo(typedOther.is_set_complete_latency());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_complete_latency()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.complete_latency, typedOther.complete_latency);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
      ...
      switch (field.id) {
        ...
        case 520: // COMPLETE_LATENCY
          if (field.type == org.apache.thrift.protocol.TType.DOUBLE) {
            this.complete_latency = iprot.readDouble();
            set_complete_latency_isSet(true);
          } else { 
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
          }
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (is_set_complete_latency()) {
      ...
      oprot.writeDouble(this.complete_latency);
      oprot.writeFieldEnd();
    }
