...
public class WorkerResources implements org.apache.thrift.TBase<WorkerResources, WorkerResources._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerResources> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.resources = new HashMap<String,Double>(2*_map632.size);
                String _key633;
                double _val634;
                for (int _i635 = 0; _i635 < _map632.size; ++_i635)
                {
                  ...
                  struct.resources.put(_key633, _val634);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.shared_resources = new HashMap<String,Double>(2*_map636.size);
                String _key637;
                double _val638;
                for (int _i639 = 0; _i639 < _map636.size; ++_i639)
                {
                  ...
                  struct.shared_resources.put(_key637, _val638);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.resources != null) {
        if (struct.is_set_resources()) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter640 : struct.resources.entrySet())
            {
              oprot.writeString(_iter640.getKey());
              oprot.writeDouble(_iter640.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.shared_resources != null) {
        if (struct.is_set_shared_resources()) {
          oprot.writeFieldBegin(SHARED_RESOURCES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter641 : struct.shared_resources.entrySet())
            {
  ...
  private static class WorkerResourcesTupleScheme extends TupleScheme<WorkerResources> {
      ...
      if (struct.is_set_resources()) {
        {
          ...
          for (Map.Entry<String, Double> _iter642 : struct.resources.entrySet())
          {
            oprot.writeString(_iter642.getKey());
            oprot.writeDouble(_iter642.getValue());
          }
        }
      }
      if (struct.is_set_shared_resources()) {
        {
          ...
          for (Map.Entry<String, Double> _iter643 : struct.shared_resources.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WorkerResources struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map644 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.resources = new HashMap<String,Double>(2*_map644.size);
          String _key645;
          double _val646;
          for (int _i647 = 0; _i647 < _map644.size; ++_i647)
          {
            ...
            struct.resources.put(_key645, _val646);
          }
        }
        struct.set_resources_isSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TMap _map648 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.shared_resources = new HashMap<String,Double>(2*_map648.size);
          String _key649;
          double _val650;
          for (int _i651 = 0; _i651 < _map648.size; ++_i651)
          {
            ...
            struct.shared_resources.put(_key649, _val650);
          }
        }
        struct.set_shared_resources_isSet(true);
      }
