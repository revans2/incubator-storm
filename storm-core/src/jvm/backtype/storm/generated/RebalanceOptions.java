...
public class RebalanceOptions implements org.apache.thrift.TBase<RebalanceOptions, RebalanceOptions._Fields>, java.io.Serializable, Cloneable, Comparable<RebalanceOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.num_executors = new HashMap<String,Integer>(2*_map392.size);
                String _key393;
                int _val394;
                for (int _i395 = 0; _i395 < _map392.size; ++_i395)
                {
                  ...
                  struct.num_executors.put(_key393, _val394);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.num_executors != null) {
        if (struct.is_set_num_executors()) {
          oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter396 : struct.num_executors.entrySet())
            {
  ...
  private static class RebalanceOptionsTupleScheme extends TupleScheme<RebalanceOptions> {
      ...
      if (struct.is_set_num_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter397 : struct.num_executors.entrySet())
          {
            oprot.writeString(_iter397.getKey());
            oprot.writeI32(_iter397.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RebalanceOptions struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map398 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.num_executors = new HashMap<String,Integer>(2*_map398.size);
          String _key399;
          int _val400;
          for (int _i401 = 0; _i401 < _map398.size; ++_i401)
          {
            _key399 = iprot.readString();
            _val400 = iprot.readI32();
            struct.num_executors.put(_key399, _val400);
          }
        }
        struct.set_num_executors_isSet(true);
      }
