...
public class RebalanceOptions implements org.apache.thrift.TBase<RebalanceOptions, RebalanceOptions._Fields>, java.io.Serializable, Cloneable, Comparable<RebalanceOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.num_executors = new HashMap<String,Integer>(2*_map382.size);
                String _key383;
                int _val384;
                for (int _i385 = 0; _i385 < _map382.size; ++_i385)
                {
                  _key383 = iprot.readString();
                  _val384 = iprot.readI32();
                  struct.num_executors.put(_key383, _val384);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.num_executors != null) {
        if (struct.is_set_num_executors()) {
          oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter386 : struct.num_executors.entrySet())
            {
  ...
  private static class RebalanceOptionsTupleScheme extends TupleScheme<RebalanceOptions> {
      ...
      if (struct.is_set_num_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter387 : struct.num_executors.entrySet())
          {
            oprot.writeString(_iter387.getKey());
            oprot.writeI32(_iter387.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RebalanceOptions struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map388 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.num_executors = new HashMap<String,Integer>(2*_map388.size);
          String _key389;
          int _val390;
          for (int _i391 = 0; _i391 < _map388.size; ++_i391)
          {
            ...
            struct.num_executors.put(_key389, _val390);
          }
        }
        struct.set_num_executors_isSet(true);
      }
