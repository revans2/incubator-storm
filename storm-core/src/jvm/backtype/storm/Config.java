...
public class Config extends HashMap<String, Object> {
   ...
   /**
    ...
    /**
     * Topology-specific classpath for the worker child process. This will be *prepended* to the usual classpath, meaning it can override the Storm classpath. This is for debugging purposes, and is
     * disabled by default. To allow topologies to be submitted with user-first classpaths,
     * set the storm.topology.classpath.beginning.enabled config to true.
     */
    @isStringOrStringList
