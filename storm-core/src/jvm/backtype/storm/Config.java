...
import backtype.storm.validation.ConfigValidationAnnotations.isPositiveNumber;
import backtype.storm.validation.ConfigValidationAnnotations.isPowerOf2;
...
public class Config extends HashMap<String, Object> {
    ...
    */
    ...
    /**
     * A list of plugins that should load the user pools for the multitenant scheduler
     */
    @isString
    public static final String MULTITENANT_SCHEDULER_USER_POOL_LOADER = "multitenant.scheduler.user.pools.loader";

    /**
     * Location for Multitenant user pool yaml local file
     */
    @isString
    public static final String MULTITENANT_SCHEDULER_USER_POOL_LOCAL_FILE = "multitenant.scheduler.user.pools.local.file";

    /**
     * Location for Multitenant aware user pool yaml uri
     */
    @isString
    public static final String MULTITENANT_SCHEDULER_USER_POOL_URI = "multitenant.scheduler.user.pools.uri";
    ...
    /**
     * A list of plugins that should load the user pools for the resource aware scheduler
     */
    @isString
    public static final String RESOURCE_AWARE_SCHEDULER_USER_POOL_LOADER = "resource.aware.scheduler.user.pools.loader";

    /**
     * Location for Resource aware user pool yaml local file
     */
    @isString
    public static final String RESOURCE_AWARE_SCHEDULER_USER_POOL_LOCAL_FILE = "resource.aware.scheduler.user.pools.local.file";

    /**
     * Location for Resource aware user pool yaml uri
     */
    @isString
    public static final String RESOURCE_AWARE_SCHEDULER_USER_POOL_URI = "resource.aware.scheduler.user.pools.uri";
