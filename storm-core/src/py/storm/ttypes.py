...
class CommonAggregateStats:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i296 in xrange(_size292):
            ...
            self.resources_map[_key297] = _val298
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resources_map is not None:
      ...
      for kiter299,viter300 in self.resources_map.items():
        oprot.writeString(kiter299.encode('utf-8'))
        oprot.writeDouble(viter300)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class TopologyStats:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i305 in xrange(_size301):
            ...
            self.window_to_emitted[_key306] = _val307
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
          ...
          for _i312 in xrange(_size308):
            ...
            self.window_to_transferred[_key313] = _val314
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.MAP:
          ...
          for _i319 in xrange(_size315):
            ...
            _val321 = iprot.readDouble()
            self.window_to_complete_latencies_ms[_key320] = _val321
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
          ...
          for _i326 in xrange(_size322):
            ...
            self.window_to_acked[_key327] = _val328
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.MAP:
          ...
          for _i333 in xrange(_size329):
            ...
            self.window_to_failed[_key334] = _val335
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.window_to_emitted is not None:
      ...
      for kiter336,viter337 in self.window_to_emitted.items():
    ...
    if self.window_to_transferred is not None:
      ...
      for kiter338,viter339 in self.window_to_transferred.items():
        oprot.writeString(kiter338.encode('utf-8'))
        oprot.writeI64(viter339)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.window_to_complete_latencies_ms is not None:
      ...
      for kiter340,viter341 in self.window_to_complete_latencies_ms.items():
    ...
    if self.window_to_acked is not None:
      ...
      for kiter342,viter343 in self.window_to_acked.items():
    ...
    if self.window_to_failed is not None:
      ...
      for kiter344,viter345 in self.window_to_failed.items():
        oprot.writeString(kiter344.encode('utf-8'))
        oprot.writeI64(viter345)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class SupervisorPageInfo:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i350 in xrange(_size346):
            _elem351 = SupervisorSummary()
            _elem351.read(iprot)
            self.supervisor_summaries.append(_elem351)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
          ...
          for _i356 in xrange(_size352):
            _elem357 = WorkerSummary()
            _elem357.read(iprot)
            self.worker_summaries.append(_elem357)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.supervisor_summaries is not None:
      ...
      for iter358 in self.supervisor_summaries:
        iter358.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.worker_summaries is not None:
      ...
      for iter359 in self.worker_summaries:
        iter359.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WorkerSummary:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i364 in xrange(_size360):
            ...
            self.component_to_num_tasks[_key365] = _val366
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 8:
  ...
  def write(self, oprot):
    ...
    if self.component_to_num_tasks is not None:
      ...
      for kiter367,viter368 in self.component_to_num_tasks.items():
...
class TopologyPageInfo:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i387 in xrange(_size383):
            _elem388 = WorkerSummary()
            _elem388.read(iprot)
            self.workers.append(_elem388)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 521:
  ...
  def write(self, oprot):
    ...
    if self.id_to_spout_agg_stats is not None:
      ...
      for kiter389,viter390 in self.id_to_spout_agg_stats.items():
    ...
    if self.id_to_bolt_agg_stats is not None:
      ...
      for kiter391,viter392 in self.id_to_bolt_agg_stats.items():
...
class ComponentPageInfo:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i398 in xrange(_size394):
            ...
            _val400.read(iprot)
            self.window_to_stats[_key399] = _val400
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 8:
        if ftype == TType.MAP:
          ...
          for _i405 in xrange(_size401):
            _key406 = GlobalStreamId()
            _key406.read(iprot)
            _val407 = ComponentAggregateStats()
            _val407.read(iprot)
            self.gsid_to_input_stats[_key406] = _val407
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.MAP:
          ...
          for _i412 in xrange(_size408):
            ...
            _val414.read(iprot)
            self.sid_to_output_stats[_key413] = _val414
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.LIST:
          ...
          for _i419 in xrange(_size415):
            _elem420 = ExecutorAggregateStats()
            _elem420.read(iprot)
            self.exec_stats.append(_elem420)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 11:
        ...
        if ftype == TType.MAP:
          ...
          for _i431 in xrange(_size427):
            _key432 = iprot.readString().decode('utf-8')
            _val433 = iprot.readDouble()
            self.resources_map[_key432] = _val433
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resources_map is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(self.resources_map))
      for kiter442,viter443 in self.resources_map.items():
        oprot.writeString(kiter442.encode('utf-8'))
        oprot.writeDouble(viter443)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class RebalanceOptions:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i448 in xrange(_size444):
            _key449 = iprot.readString().decode('utf-8')
            _val450 = iprot.readI32()
            self.num_executors[_key449] = _val450
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
          ...
          for _i455 in xrange(_size451):
            ...
            for _i462 in xrange(_size458):
              ...
              _val457[_key463] = _val464
            iprot.readMapEnd()
            self.topology_resources_overrides[_key456] = _val457
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.num_executors is not None:
      ...
      for kiter465,viter466 in self.num_executors.items():
    ...
    if self.topology_resources_overrides is not None:
      ...
      for kiter467,viter468 in self.topology_resources_overrides.items():
        oprot.writeString(kiter467.encode('utf-8'))
        oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(viter468))
        for kiter469,viter470 in viter468.items():
          oprot.writeString(kiter469.encode('utf-8'))
          oprot.writeDouble(viter470)
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class Credentials:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i475 in xrange(_size471):
            _key476 = iprot.readString().decode('utf-8')
            _val477 = iprot.readString().decode('utf-8')
            self.creds[_key476] = _val477
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.creds is not None:
      ...
      for kiter478,viter479 in self.creds.items():
        oprot.writeString(kiter478.encode('utf-8'))
        oprot.writeString(viter479.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i484 in xrange(_size480):
            _elem485 = AccessControl()
            _elem485.read(iprot)
            self.acl.append(_elem485)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
...
class ListBlobsResult:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i491 in xrange(_size487):
            _elem492 = iprot.readString().decode('utf-8')
            self.keys.append(_elem492)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.keys is not None:
      ...
      for iter493 in self.keys:
        oprot.writeString(iter493.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class LogConfig:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i498 in xrange(_size494):
            ...
            _val500 = LogLevel()
            _val500.read(iprot)
            self.named_logger_level[_key499] = _val500
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.named_logger_level is not None:
      ...
      for kiter501,viter502 in self.named_logger_level.items():
...
class TopologyHistoryInfo:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i507 in xrange(_size503):
            _elem508 = iprot.readString().decode('utf-8')
            self.topo_ids.append(_elem508)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.topo_ids is not None:
      ...
      for iter509 in self.topo_ids:
        oprot.writeString(iter509.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class SupervisorInfo:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i514 in xrange(_size510):
            ...
            self.used_ports.append(_elem515)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        ...
        if ftype == TType.MAP:
          ...
          for _i526 in xrange(_size522):
            _key527 = iprot.readString().decode('utf-8')
            _val528 = iprot.readString().decode('utf-8')
            self.scheduler_meta[_key527] = _val528
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
        ...
        if ftype == TType.MAP:
          ...
          for _i533 in xrange(_size529):
            _key534 = iprot.readString().decode('utf-8')
            _val535 = iprot.readDouble()
            self.resources_map[_key534] = _val535
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.used_ports is not None:
      ...
      for iter536 in self.used_ports:
    ...
    if self.scheduler_meta is not None:
      ...
      for kiter538,viter539 in self.scheduler_meta.items():
        oprot.writeString(kiter538.encode('utf-8'))
        oprot.writeString(viter539.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.uptime_secs is not None:
    ...
    if self.resources_map is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(self.resources_map))
      for kiter540,viter541 in self.resources_map.items():
        oprot.writeString(kiter540.encode('utf-8'))
        oprot.writeDouble(viter541)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          self.port = set()
          (_etype545, _size542) = iprot.readSetBegin()
          for _i546 in xrange(_size542):
            _elem547 = iprot.readI64()
            self.port.add(_elem547)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Assignment:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i553 in xrange(_size549):
            ...
            _val555 = iprot.readString().decode('utf-8')
            self.node_host[_key554] = _val555
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.MAP:
          ...
          for _i560 in xrange(_size556):
            ...
            _val562 = NodeInfo()
            _val562.read(iprot)
            self.executor_node_port[_key561] = _val562
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
          ...
          for _i573 in xrange(_size569):
            ...
            for _i580 in xrange(_size576):
              ...
              _key574.append(_elem581)
            iprot.readListEnd()
            _val575 = iprot.readI64()
            self.executor_start_time_secs[_key574] = _val575
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.MAP:
          ...
          for _i586 in xrange(_size582):
            _key587 = NodeInfo()
            _key587.read(iprot)
            _val588 = WorkerResources()
            _val588.read(iprot)
            self.worker_resources[_key587] = _val588
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.node_host is not None:
      ...
      for kiter589,viter590 in self.node_host.items():
        oprot.writeString(kiter589.encode('utf-8'))
        oprot.writeString(viter590.encode('utf-8'))
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.executor_node_port is not None:
      ...
      for kiter591,viter592 in self.executor_node_port.items():
        oprot.writeListBegin(TType.I64, len(kiter591))
        for iter593 in kiter591:
    ...
    if self.worker_resources is not None:
      ...
      for kiter597,viter598 in self.worker_resources.items():
        kiter597.write(oprot)
...
class StormBase:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i603 in xrange(_size599):
            _key604 = iprot.readString().decode('utf-8')
            _val605 = iprot.readI32()
            self.component_executors[_key604] = _val605
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.component_executors is not None:
      ...
      for kiter606,viter607 in self.component_executors.items():
        oprot.writeString(kiter606.encode('utf-8'))
        oprot.writeI32(viter607)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class ClusterWorkerHeartbeat:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i612 in xrange(_size608):
            _key613 = ExecutorInfo()
            _key613.read(iprot)
            _val614 = ExecutorStats()
            _val614.read(iprot)
            self.executor_stats[_key613] = _val614
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    ...
    if self.executor_stats is not None:
      ...
      for kiter615,viter616 in self.executor_stats.items():
        kiter615.write(oprot)
...
class LocalStateData:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i621 in xrange(_size617):
            ...
            _val623 = ThriftSerializedObject()
            _val623.read(iprot)
            self.serialized_parts[_key622] = _val623
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.serialized_parts is not None:
      ...
      for kiter624,viter625 in self.serialized_parts.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i630 in xrange(_size626):
            _elem631 = ExecutorInfo()
            _elem631.read(iprot)
            self.executors.append(_elem631)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
...
class LSApprovedWorkers:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i637 in xrange(_size633):
            _key638 = iprot.readString().decode('utf-8')
            _val639 = iprot.readI32()
            self.approved_workers[_key638] = _val639
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.approved_workers is not None:
      ...
      for kiter640,viter641 in self.approved_workers.items():
        oprot.writeString(kiter640.encode('utf-8'))
        oprot.writeI32(viter641)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class LSSupervisorAssignments:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i646 in xrange(_size642):
            ...
            _val648 = LocalAssignment()
            _val648.read(iprot)
            self.assignments[_key647] = _val648
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.assignments is not None:
      ...
      for kiter649,viter650 in self.assignments.items():
        oprot.writeI32(kiter649)
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i655 in xrange(_size651):
            _elem656 = ExecutorInfo()
            _elem656.read(iprot)
            self.executors.append(_elem656)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i668 in xrange(_size664):
            _elem669 = iprot.readString().decode('utf-8')
            self.groups.append(_elem669)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class LSTopoHistoryList:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i676 in xrange(_size672):
            _elem677 = LSTopoHistory()
            _elem677.read(iprot)
            self.topo_history.append(_elem677)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.topo_history is not None:
      ...
      for iter678 in self.topo_history:
        iter678.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i690 in xrange(_size686):
            _elem691 = iprot.readString().decode('utf-8')
            self.pulseIds.append(_elem691)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
